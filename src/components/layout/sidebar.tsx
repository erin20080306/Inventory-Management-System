...
const sections: NavSection[] = [
  {
    label: "總覽",
    items: [{ title: "儀表板", href: "/dashboard", icon: LayoutDashboard, perm: "dashboard.view" }],
  },
  {
    label: "進銷存",
    items: [
  ...
  {
    label: "報表",
    items: [{ title: "財務報表", href: "/reports", icon: BarChart3, perm: "reports.view" }],
  },
  {
    label: "系統",
    items: [
  ...
  return (
    <aside className="hidden md:flex w-64 shrink-0 flex-col border-r bg-sidebar text-sidebar-foreground">
      <div className="flex h-16 items-center gap-2 px-5 border-b border-white/10">
        <div className="h-8 w-8 rounded-md bg-white text-slate-900 flex items-center justify-center">
